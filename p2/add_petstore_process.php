...
{
    $error = "All fields requre data, except <b>Notes</b>. Check all fields and try again.";
    include('global/error.php');
}


elseif (!is_numeric($pst_ytd_sales_v) || $pst_ytd_sales_v <= 0)
{
...
{
    $error = 'Street can only contain letters, numbers, hyphens, and periods.';
    include('global/error.php');
}

elseif ($valid_city === false)
{
    echo 'Error in pattern!';
}
...
{
    $error = 'YTD Sales must contain no more than 10 digits, including decimal points.';
    include('global/error.php');
}
