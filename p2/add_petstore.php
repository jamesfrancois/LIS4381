			...
			fields: {
					...
					city: {
							...
							validators: {
									...
									message: 'City can only contain letters, numbers, commas, hyphens, and space character (29 Palms)'
					...
					ytdsales: {
							...
							validators: {
									...
									stringLength: {
										...
										message: 'YTD sales can no more than 10 digits, including decimal point'
