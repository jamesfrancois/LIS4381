    ...
    public static void getRequirements()
{
    ...
    System.out.println("Developer: James François");
    ...
    System.out.println("Program must check for non-integers and non-numeric values.");
    System.out.println("Program continues to prompt for user entry until no longer requested, prompt accepts under or lower case letters.");
    ...
    public static void getSphereVolume()
    {
      ...
      gallons = volume/231;
      System.out.println("Sphere volume: " + String.format("%,.2f",gallons) + " liqud U.S. gallons");
